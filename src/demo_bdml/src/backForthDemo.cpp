...
//  client.waitForServer();
  ...
  while (true) {
	  ...
	  trajectory.poses[0].position.x = .2;
	  ...
	  trajectory.poses[0].orientation.y = .4;
	...
	trajectory.poses[0].position.x = .2;
	trajectory.poses[0].position.y = .4;
	trajectory.poses[0].position.z = .21;
	client.sendGoal(trajectory);
	client.waitForResult();
	...
	trajectory.poses[0].position.x = -0.2;
	trajectory.poses[0].position.y = .4;
	trajectory.poses[0].position.z = .5;
	client.sendGoal(trajectory);
	client.waitForResult();
